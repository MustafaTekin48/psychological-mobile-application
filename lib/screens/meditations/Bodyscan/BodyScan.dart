...
class BodyScan extends StatefulWidget {
  ...
  @override
  State<BodyScan> createState() => _BodyScanState();
}
...
class _BodyScanState extends State<BodyScan> {
  ...
  // Body Scan specific motivation messages
  final List<String> _motivationMessages = [
    'Şimdi dikkatini ayak parmaklarına odakla.',
    'Ayak tabanlarındaki hisleri fark et.',
    'Bacaklarındaki gerginliği nefesinle gevşet.',
    'Karın bölgenin nefes alışverişindeki hareketini gözlemle.',
    'Göğsünün ve omuzlarının rahatladığını hisset.',
    'Kollarından ellerine doğru hislerini fark et.',
    'Boynundaki ve çenendeki gerginliği serbest bırak.',
    'Başının üst kısmındaki hisleri fark et, tüm bedenin rahatlıyor.',
  ];

  final List<String> startmessageList = [
    'Beden tarama meditasyonuna hoş geldin.',
    'Sessiz bir yer bul ve rahatla.',
    'Bedeninin her bir noktasını keşfetmeye hazırlan.',
  ];

  final List<String> endmessageList = [
    'Bedeninle bağlantı kurduğun için tebrikler!',
    'Bu farkındalığı gününe taşı.',
    'Daha sakin ve merkezlenmiş hisset.'
  ];
        ...
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            builder: (context) => meditation_journal(
              ...
              meditationThemeName: "Beden Tarama Meditasyonu",
            ),
          ),
        );
      },
